...
echo "Specification-Version: 0.1.0" >> server_manifest.mf
...
echo "Implementation-Version: Blackhat2008" >> server_manifest.mf
...
echo "Specification-Version: 0.1.0" >> manager_manifest.mf
...
echo "Implementation-Version: Blackhat2008" >> manager_manifest.mf
